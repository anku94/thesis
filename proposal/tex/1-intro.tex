...
Our work developed systems and algorithms to advance workflow efficiency of parallel codes on both
...
This experience led us to develop ORCA, a general-purpose approach that enables efficiency wins in
...
CARP (Continuous Adaptive Range Partitioner)~\cite{Jain2024:CARP}, an adaptive partitioner that
adapts to arbitrary key distributions and partitions them in a single streaming pass.
...
\paragraph{Our Contributions}~\cite{Jain2025:AMR}
...
semantics and Arrow.
ORCA (\emph{Observability with Realtime Control and Aggregation}) uses a tree-based overlay network
with distributed query planning and a async control path.
