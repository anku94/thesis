...
While execution variability is a known issue, it is often overlooked in performance analyses, which
are typically conducted offline and disconnected from runtime context.
...
tradeoffs---such as load balance versus communication locality---whose optimal configuration
also benefits from real-time visibility into application behavior.
