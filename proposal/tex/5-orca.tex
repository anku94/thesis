...
\begin{figure}[h]
  ...
  \caption{A comparison of different observability approaches for BSP systems, modeled as a two-dimensional
  grid of ranks and timesteps. Tracing captures all event data, but re
  }
