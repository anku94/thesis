...
(\cref{fig:carp:distrib-vpic,fig:carp:distrib-amr}).
While all VPIC timesteps have long tails, more pivots help when they become extremely long
as the simulation progresses.
Sketch-based quantile estimation methods can provide more robustness for such distributions~\cite{Karni2016:KLLSketch}.
% More robust pivot estimation methods can provide more resilience for such distributions.
