...
Redistribution rebalances blocks across ranks as the simulation evolves, adapting to
changes from mesh refinement or coarsening.
It is triggered when blocks are tagged for refinement based on physical criteria, like solution
