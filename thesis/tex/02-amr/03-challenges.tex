...
% modified.
For example, optimizing for communication locality did not reliably improve end-to-end performance
initially.
...
unrestricted access to low-level tools like \texttt{perf}~\cite{:PerfLinuxProfiling} and
...
We address these challenges sequentially: \S\ref{sec:amr:tele} describes the 
tuning and analytics methods
 used to establish reliable telemetry, and \S\ref{sec:amr:design} presents placement
