...
\section{Denoising Telemetry For Placement}
\label{sec:amr:tele}
...
\subsection{Tuning The Software Stack}
\label{sec:amr:tele:sw}
\figtunesw
...
(\cref{fig:amr:chal:regr}), was traced using \texttt{perf}~\cite{Linux:LinuxPerf} to contention in the
...
\subsection{A Critical Path Model of Execution}
\label{sec:amr:tele:critp}
\figcritp
