...
\Cref{fig:amr:eval:runtime:wide} shows total runtime across all policies,
...
\Cref{fig:amr:eval:runtime:wide} also shows that all CPLX configurations outperform
...
\Cref{fig:amr:eval:tradeoff:wide} isolates the core tradeoff by showing P2P communication
...
\cref{fig:amr:eval:comm:wide} shows the breakdown of local (intra-node shared memory) and
...
While inspired by the Halo3D-26 fixed-grid benchmark~\cite{Vitti2015:Ember}, \commbench{} simulates
