...
correctness~\cite{\citeGroupMLCorrectness}, but each reimplements subsets of collection, aggregation,
...
In a simple internal port of HTA analyses from JSON to Parquet, we observed 12$\times$ faster data loading
