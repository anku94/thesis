...
\subsection{Transport: TBON and Incast-Optimized}
...
OrcaFlow is backed by a TBON-aware distributed planner and query engine built on Apache DataFusion~\cite{Lamb2024:DataFusion}.
