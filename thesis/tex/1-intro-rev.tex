...
CARP addresses this with adaptive online range partitioning guided by a reconstructed view of
...
% \label{sec:intro:orca:statusquo}
...
% % and do not directly encode synchronized BSP windows, so answering even basic cross-rank questions
% % requires substantial ETL and expensive global joins.
...
% rendering them increasingly impractical with scale.
...
\begin{itemize}
  ...
  \item \cref{chap:carp-paper,chap:amr-paper,chap:orca-paper} present CARP, the AMR study, and ORCA respectively.
