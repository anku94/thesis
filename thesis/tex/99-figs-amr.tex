...
\newcommand{\figchal}{
  ...
  \begin{subfigure}{\columnwidth}
    \centering
    \includegraphics
    [width=\columnwidth, height=0.18\textheight, keepaspectratio]
...
\newcommand{\figtunehw}{
  \begin{figure}[t]
    \centering
		\includegraphics [width=\columnwidth, height=0.3\textheight, keepaspectratio]
...
\newcommand{\figcritp}{
  ...
  \begin{subfigure}{0.5\textwidth}
    \centering
    \includegraphics
    [width=0.99\linewidth, height=0.1\textheight, keepaspectratio]
...
\newcommand{\figoctree}{
  ...
  \centering
  \includegraphics
  [width=\columnwidth, height=0.25\textheight, keepaspectratio]
...
\newcommand{\figevalbwwidemini}{
  \begin{figure}[t]
    \begin{subfigure}{\textwidth}
      ...
      clip,
      width=\textwidth, height=0.15\textheight, keepaspectratio]{data/figs/amr_blastwave_runtime_wide.pdf}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      trim=0cm 0.2cm 0cm 0.2cm,
      clip,
      width=\textwidth, height=0.12\textheight, keepaspectratio]{data/figs/amr_blastwave_tradeoff_wide_mini.pdf}
    ...
    \begin{subfigure}{0.5\textwidth}
      ...
      trim=0cm 0.2cm 0cm 0.2cm,
      clip,
      width=\textwidth, height=0.12\textheight, keepaspectratio]{data/figs/amr_blastwave_comm_wide_mini.pdf}
...
\newcommand{\figmicro}{
  \begin{figure}[t]
    \begin{subfigure}{0.5\textwidth}
      \centering
      \includegraphics[width=\columnwidth, height=0.12\textheight, keepaspectratio]
    ...
    \begin{subfigure}{0.5\textwidth}
      \centering
      \includegraphics
      [trim=.1cm 7.6cm .1cm .1cm, clip, width=\columnwidth, height=0.12\textheight, keepaspectratio]
    ...
    \begin{subfigure}{0.5\textwidth}
      \includegraphics
      [trim=.1cm .4cm .1cm 7.6cm, clip, width=\columnwidth, height=0.12\textheight, keepaspectratio]
      {data/figs/amr_scaling.pdf}
      \caption{
