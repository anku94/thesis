...
\newcommand{\figdeslayout}{
  \centering
  \includegraphics[trim=3.5cm 4.0cm 3.5cm 4.3cm,clip,width=\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_layout_v2.pdf}
...
\newcommand{\figdesarch}{
  \centering
  \includegraphics[trim=8cm 7.8cm 8cm 6.5cm,clip,width=0.9\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_arch_v12mini.pdf}
...
\newcommand{\figdessend}{
  \centering
  \includegraphics[trim=7.9cm 6.5cm 7.7cm 4.8cm,clip,width=0.85\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_sender_wobg_v6.pdf}
...
\newcommand{\figdeshist}{
  \centering
  \includegraphics[trim=7.4cm 3.2cm 5.7cm 3.3cm,clip,width=0.9\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_reneg_hists_v4.pdf}
...
\newcommand{\figdeskoidb}{
  \includegraphics[trim=6cm 4cm 4cm 4.7cm,clip,width=0.5\textwidth,height=0.2\textheight,keepaspectratio]{data/figs/carp_carpdb_log_v3.pdf}
...
\newcommand{\figktqlat} {
  \centering
  \includegraphics[trim=0.7cm 0.84cm 0.5cm 0.70cm,clip,width=\textwidth,height=0.2\textheight,keepaspectratio]{data/figs/carp_qlatvssel.v6.pdf}
...
\newcommand{\figktrt}{
  \centering
  \includegraphics[trim=0.6cm 0.90cm 0.6cm 0.80cm,clip,width=\linewidth,height=0.2\textheight,keepaspectratio]{data/figs/carp_runtime.v4.werr.pdf}
...
\newcommand{\figevalycsb}{
  \centering
  \includegraphics[trim=0.5cm 0.2cm 0.7cm 0.7cm,clip,width=0.9\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_query.ycsb.v3.pdf}
...
\newcommand{\figevaldyn}{
  \centering
  \includegraphics[trim=0.6cm 1.7cm 0.9cm 3.8cm,clip,width=0.9\columnwidth,height=0.25\textheight,keepaspectratio]{data/figs/carp_pvtbench.adapt.pdf}
  \caption{
...
\newcommand{\figevalrtplat}{
  \centering
  \includegraphics[trim=0.6cm 2.6cm 0.6cm 3.6cm,clip,width=\columnwidth,height=0.2\textheight,keepaspectratio]{data/figs/carp_rtp.latvspvtcnt.pdf}
...
\newcommand{\figevalpvtcnt}{
  \centering
  \includegraphics[trim=0.6cm 1.7cm 0.7cm 3.7cm,clip,width=\columnwidth,height=0.2\textheight,keepaspectratio]{data/figs/carp_pvtbench.epxpp.pdf}
