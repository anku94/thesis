...
\newcommand{\figDesignArch}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.48\textwidth, trim=0.2cm 0cm 0.2cm 0cm, clip]{data/figs/orca_arch.pdf}
...
\newcommand{\figDesignPlan}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.24\textwidth, trim=0.35cm 0cm 0.2cm 0.4cm, clip]{data/figs/orca_plan.pdf}%
    \includegraphics[width=0.24\textwidth, trim=0.3cm 0cm 0.3cm 0.4cm, clip]{data/figs/orca_plan2.pdf}
...
% Design: TS2PC Protocol
\newcommand{\figDesignTwopc}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=0.48\textwidth, trim=0.2cm 0cm 0.2cm 0cm, clip]{data/figs/orca_ts2pc.pdf}
    \caption{Timestep-linked two-phase commit (TS2PC).
...
\newcommand{\figEvalOverhead}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{data/figs/orca_amr_tracer_runtimes.pdf}
...
\newcommand{\figEvalSizeOnly}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{data/figs/orca_amr_tracesizes_line.pdf}
...
\newcommand{\figEvalQueryOnly}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{data/figs/orca_query_suite.pdf}
...
\newcommand{\figEvalArch}{%
  \begin{figure}[t]
    ...
    \begin{subfigure}[t]{0.65\columnwidth}
      \centering
      \includegraphics{data/figs/orca_dftracer_comp.pdf}
      \caption{Compression impact.}\label{fig:orca:eval-arch-dft}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{0.34\columnwidth}
      \centering
      \includegraphics{data/figs/orca_ofi_tcp_tracer_runtimes.pdf}
...
\newcommand{\figEvalOrcaNative}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{data/figs/orca_ontv_combined.pdf}
...
\newcommand{\figEvalAgentic}{%
  \begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{data/figs/orca_agentic_timeline.pdf}
